...
class LoginViewSimple:
    def __init__(self, master):
        ...
        print("LoginViewSimple creada exitosamente")
    ...
    def create_login_interface(self):
        ...
        print("Creando interfaz de login...")
        ...
        print("Hover effects configurados")
        ...
        print("Interfaz de login completada")
